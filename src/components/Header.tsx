  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link className="my-[0.30rem] p-[0.35rem] hover:bg-[#383838]/50 rounded" href="#sobre">
          Sobre
        </Link>
        <hr className="opacity-50" />
        <Link className="my-[0.30rem] p-[0.35rem] hover:bg-[#383838]/50 rounded" href="#stack">
          Stack
        </Link>
        <hr className="opacity-50" />
        <Link className="my-[0.30rem] p-[0.35rem] hover:bg-[#383838]/50 rounded" href="#projetos">
          Projetos
        </Link>
        <hr className="opacity-50" />
        <Link className="my-[0.30rem] p-[0.35rem] hover:bg-[#383838]/50 rounded" href="#formacao">
          Formação
        </Link>
        <hr className="opacity-50" />
        <Link className="my-[0.30rem] p-[0.35rem] hover:bg-[#383838]/50 rounded" href="#contato">
          Contato
        </Link>
        <hr className="opacity-50" />
      </nav>
